...
/* harmony import */ var _services_carrera_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/carrera_service */ "./resources/js/services/carrera_service.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    loadCarreras: function () {
      var _loadCarreras = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        var response;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return _services_carrera_service__WEBPACK_IMPORTED_MODULE_7__.loadCarreras();

              case 3:
                response = _context5.sent;
                this.carreras = response.data; //   console.log(response);
    ...
    loadEstudiantes: function () {
      var _loadEstudiantes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var response;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.prev = 0;
                _context7.next = 3;
                return _services_estudiante_service__WEBPACK_IMPORTED_MODULE_1__.getEstudiantes();

              case 3:
                response = _context7.sent;
                this.allEstudiantes = response.data; //  console.log(this.allEstudiantes);
    ...
    loadSolicitudes: function () {
      var _loadSolicitudes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        var token, response;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.prev = 0;
                token = JSON.parse(localStorage.getItem('larave-vue-spa-token'));
                console.log(token);
                _context9.next = 5;
                return _services_solicitud_service__WEBPACK_IMPORTED_MODULE_0__.loadSolicitudes(this.comboData, this.pagination.current, token);
    ...
    loadSearch: function () {
      var _loadSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(e) {
    ...
    createSolicitud: function () {
      var _createSolicitud = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 21:
                ...
                _context11.next = _context11.t1 === 401 ? 26 : _context11.t1 === 500 ? 28 : 29;
                break;
    ...
    updateSolicitud: function () {
      var _updateSolicitud = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
        var formData, response;
    ...
    deleteSolicitud: function () {
      var _deleteSolicitud = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(solicitud) {
        var _this2 = this;
            ...
            switch (_context14.prev = _context14.next) {
              case 0:
                Swal.fire({
                  ...
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(result) {
    ...
    aprobarEnvio: function () {
      var _aprobarEnvio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(solicitud) {
        var _this3 = this;
            ...
            switch (_context16.prev = _context16.next) {
              case 0:
                Swal.fire({
                  ...
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(result) {
    ...
    aprobarRespuesta: function () {
      var _aprobarRespuesta = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(solicitud) {
        var _this4 = this;
            ...
            switch (_context18.prev = _context18.next) {
              case 0:
                Swal.fire({
                  ...
                  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(result) {
    ...
    correlativo: function () {
      var _correlativo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee19(solicitud) {
        return _regeneratorRuntime().wrap(function _callee19$(_context19) {
          while (1) {
            switch (_context19.prev = _context19.next) {
              case 0:
                alert("as ".concat(solicitud.id)); //   await solicitudService.generarCorrelativoSolicitud(soli.id);

                this.loadSolicitudes();
                this.correlativoData = _objectSpread({}, soli); //  this.$store.dispatch("GET_ACTUAL_CORRELATIVO", this.correlativoData);
                //   this.changeDate(soli);
                //   this.viewData = { ...soli };
                //  this.$store.dispatch("GET_SOLICITUDES", this.viewData);
      ...
      function correlativo(_x10) {
        return _correlativo.apply(this, arguments);
      }
...
/* harmony export */ });
/* harmony import */ var _http_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./http_service */ "./resources/js/services/http_service.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth_service */ "./resources/js/services/auth_service.js");


function createSolicitud(data) {
  return (0,_http_service__WEBPACK_IMPORTED_MODULE_0__.http)().post('/solicitudes', data);
}
function loadSolicitudes(carrera, page, token) {
...
function filtroSolicitudes(carrera, search, token) {
  return (0,_http_service__WEBPACK_IMPORTED_MODULE_0__.http)().get("filtroSolicitud/?carrera=".concat(carrera, "&search=").concat(search), {
    headers: {
      'Authorization': 'Bearer ' + token
    }
  });
...
var staticRenderFns = [
  function () {
    ...
    return _c(
      ...
      [_c("strong", [_vm._v("DIRECCION DE CARRERA ")])]
    )
  },
  function () {
    var _vm = this
