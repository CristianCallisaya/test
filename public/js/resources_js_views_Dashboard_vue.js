...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    showDialogObs: function showDialogObs() {
    ...
    [
      ...
      _c(
        "v-dialog",
        {
          attrs: { "max-width": "500" },
          model: {
            value: _vm.observacionDialog,
            callback: function ($$v) {
              _vm.observacionDialog = $$v
            },
            expression: "observacionDialog",
          },
        },
        [
          _c(
            ...
            [
              _c(
                "v-card",
                [
                  _c("v-card-title", [_vm._v("Agregar observacion")]),
                  _vm._v(" "),
                  _c(
                    "v-card-text",
                    [
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "v-btn",
                            { attrs: { color: "blue darken-2", dark: "" } },
                            [_vm._v("Guardar")]
                          ),
                          _vm._v(" "),
                          _c("v-spacer"),
