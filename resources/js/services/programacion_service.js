...
export function loadDefensasPanel2(search){
    return http().get(`getPanel2?search=${search}`);
}
...
//panel 3
export function loadDefensasPanel3(search){
    return http().get(`getPanel3?search=${search}`);
}
