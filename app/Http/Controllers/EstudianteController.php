...
{   
    ...
    $estudiante = Estudiante::with('relacionAsignacion.relacionTribunal','relacionSolicitud.relacionDocente','relacionProgramacion.relacionDetalleEstudiante','relacionProgramacion','relacion_carrera','relacionObservacion')->when(request('carrera'), function ($query) {
